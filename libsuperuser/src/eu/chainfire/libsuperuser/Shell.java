...
public class Shell {    
    ...
    /**
     * Command per line callback for parsing the output line by line without buffering
     *
     * It also notifies the recipient of the completion of a command
    ...
    public static class Builder {
         ...
         * @return This Builder object for method chaining
         */
        public Builder addCommand(String[] commands, int code, OnCommandResultListener onCommandResultListener) { this.commands.add(new Command(commands, code, onCommandResultListener, null));	return this; }
    ...
    public static class Interactive {		
         ...
         * @param command Command to execute
         */
        public void addCommand(String command) { addCommand(command, 0, (OnCommandResultListener) null); }
        ...
        /**
         * <p>Add a command to execute, with a callback.
         * This callback gobbles the output line by line without buffering it and also returns the result code on completion.</p>
         *
         * <p>The thread on which the callback executes is dependent on various factors, see {@link Shell.Interactive} for further details</p>
         *
         * @param command Command to execute
         ...
         */
        public void addCommand(String command, int code, OnCommandLineListener onCommandLineListener) { addCommand(new String[] { command }, code, onCommandLineListener); }
        ...
        /**
         * <p>Add commands to execute, with a callback.
         * This callback gobbles the output line by line without buffering it and also returns the result code on completion.</p>
         *
         * <p>The thread on which the callback executes is dependent on various factors, see {@link Shell.Interactive} for further details</p>
         *
         ...
         * @param onCommandLineListener Callback
         */
        public void addCommand(List<String> commands, int code, OnCommandLineListener onCommandLineListener) { addCommand(commands.toArray(new String[commands.size()]), code, onCommandLineListener); }
         ...
         * @param commands Commands to execute
         */
        public void addCommand(String[] commands) { addCommand(commands, 0, (OnCommandResultListener) null); }
